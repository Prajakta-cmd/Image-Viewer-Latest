  ...
  loginClickHandler = () => {
    ...
    if (
      ...
      sessionStorage.setItem(
        "access-token",
        "IGQVJWcW5paVhKMXp3VXNfLUtzN3dnbTc2X1FoV2ZAfb0VyQXpUUW5Fd0xTbmhtOVJkYVhmb3RMZAU9Qdk5uV28wb2VJRlRON29FcGtzTW1KZA2JvenpKcmNuY0RSWnY1eG90Uk1DMlRJczZAqdXdELTV3bAZDZD"
      );
      this.setState({ incorrectUsernamePassword: "dispNone" });
